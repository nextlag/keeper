...
func (r *Repo) AddNote(note *entity.SecretNote) error {
...
func (r *Repo) SaveNotes(notes []entity.SecretNote) error {
	if len(notes) == 0 {
		return nil
	}
	userID := r.getUserID()
...
func (r *Repo) GetNoteByID(noteID uuid.UUID) (note entity.SecretNote, err error) {
...
func (r *Repo) DelNote(noteID uuid.UUID) error {
