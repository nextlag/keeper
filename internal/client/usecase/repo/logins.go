...
func (r *Repo) AddLogin(login *entity.Login) error {
...
func (r *Repo) SaveLogins(logins []entity.Login) error {
	if len(logins) == 0 {
		return nil
	}
	userID := r.getUserID()
...
func (r *Repo) GetLoginByID(loginID uuid.UUID) (login entity.Login, err error) {
...
func (r *Repo) DelLogin(loginID uuid.UUID) error {
